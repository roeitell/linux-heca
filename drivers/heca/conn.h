...
int add_dsm_request(struct heca_request *, struct heca_connection *,
                ...
                struct heca_message *);
inline int request_queue_empty(struct heca_connection *);
inline int request_queue_full(struct heca_connection *);
...
int tx_dsm_send(struct heca_connection *, struct tx_buffer_element *);
...
int dsm_send_tx_e(struct heca_connection *, struct tx_buffer_element *, int, int, u32,
