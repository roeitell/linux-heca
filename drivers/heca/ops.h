...
int process_pull_request(struct heca_connection_element *,
                struct rx_buffer_element *);
int process_svm_status(struct heca_connection_element *,
                struct rx_buffer_element *);
int process_page_redirect(struct heca_connection_element *,
                struct tx_buffer_element *, u32);
int process_page_response(struct heca_connection_element *,
                struct tx_buffer_element *);
int process_page_claim(struct heca_connection_element *, struct heca_message *);
int process_claim_ack(struct heca_connection_element *,
                struct tx_buffer_element *, struct heca_message *);
void deferred_gup_work_fn(struct work_struct *);
int process_page_request_msg(struct heca_connection_element *,
                struct heca_message *);
...
int dsm_process_request_query(struct heca_connection_element *,
                struct rx_buffer_element *);
