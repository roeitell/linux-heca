...
#define HECA_DECLARE_EVENT_FULL(name) \
...
HECA_DECLARE_EVENT_FULL(heca_do_page_fault);
HECA_DECLARE_EVENT_FULL(heca_cache_add_send);
HECA_DECLARE_EVENT_FULL(heca_do_page_fault_complete);
HECA_DECLARE_EVENT_FULL(heca_get_remote_page);
HECA_DECLARE_EVENT_FULL(heca_pull_req_complete);
HECA_DECLARE_EVENT_FULL(heca_try_pull_req_complete_fail);
HECA_DECLARE_EVENT_FULL(heca_process_page_request_complete);
HECA_DECLARE_EVENT_FULL(heca_process_page_request);
HECA_DECLARE_EVENT_FULL(heca_send_request);
HECA_DECLARE_EVENT_FULL(heca_delayed_initiated_fault);
HECA_DECLARE_EVENT_FULL(heca_immediate_initiated_fault);
HECA_DECLARE_EVENT_FULL(heca_redirect);
HECA_DECLARE_EVENT_FULL(heca_pull_req_success);
HECA_DECLARE_EVENT_FULL(heca_defer_gup);
HECA_DECLARE_EVENT_FULL(heca_defer_gup_execute);
HECA_DECLARE_EVENT_FULL(heca_claim_page);
HECA_DECLARE_EVENT_FULL(heca_write_fault);
HECA_DECLARE_EVENT_FULL(heca_discard_read_copy);
...
#define HECA_DECLARE_EVENT_MESSAGE(name) \
...
HECA_DECLARE_EVENT_MESSAGE(heca_rx_msg);
HECA_DECLARE_EVENT_MESSAGE(heca_tx_msg);
HECA_DECLARE_EVENT_MESSAGE(heca_queued_request);
...
#define HECA_DECLARE_EVENT_BASIC(name) \
        DEFINE_EVENT(heca_basic_template, name, TP_PROTO(int id), TP_ARGS(id));
HECA_DECLARE_EVENT_BASIC(heca_is_congested);
HECA_DECLARE_EVENT_BASIC(heca_free_hproc);
HECA_DECLARE_EVENT_BASIC(heca_extract_pte_data_err);
HECA_DECLARE_EVENT_BASIC(heca_deferred_fault);
HECA_DECLARE_EVENT_BASIC(heca_flushing_requests);
