...
struct dsm_functions
{
    ...
    int (*_page_local)(unsigned long, struct dsm_vm_id *, struct mm_struct *);                      //_page_local;
...
int dsm_insert_page(struct mm_struct *, struct vm_area_struct *, pte_t *, unsigned long, struct page *, struct dsm_vm_id *);
